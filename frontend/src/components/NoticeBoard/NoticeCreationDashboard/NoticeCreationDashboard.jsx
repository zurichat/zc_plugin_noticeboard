...
import './NoticeCreationDashboard.css';
...
function NoticeCreationDashboard() {
    ...
    <div className="dashboard-container">
      ...
      <form>
        <div>
          ...
          <span className="input-group">
            <label>To:</label>
            <select value="Mark" onChange={e => setRecipient(e.target.value)}>
              <option>Mark</option>
              <option>Steve</option>
              <option>James</option>
            </select>
      ...
      <div className="settings-container">
        ...
        <div className="content-formaters">
          ...
          <span className={activeOption === 'pin' ? 'active' : ''} 
            onClick={() => setActiveOption('pin')}><img src={pin_icon} alt="pin" /></span>
...
export default NoticeCreationDashboard;