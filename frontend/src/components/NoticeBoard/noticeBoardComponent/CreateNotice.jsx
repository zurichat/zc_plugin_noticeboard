    ...
    <div className="dashboard-container">
      ...
      <div className="settings-container">
        ...
        <div className="content-formaters">
          <span
            className={activeOption === "text-transform" ? "active" : ""}
          ...
          <span
            onClick={() => {
              !noticeContent.includes("@") &&
                setNoticeContent("@" + noticeContent);
            }}
          >
            <img src={at_icon} alt="at" />
          </span>
          <span
            className={activeOption === "emoji" ? "active" : ""}
            onClick={() => setActiveOption("emoji")}
          >
            <img src={emoji_icon} alt="emoji" />
          </span>
          <span
            className={activeOption === "pin" ? "active" : ""}
            onClick={() => setActiveOption("pin")}
          >
            <img src={file_link_icon} alt="pin" />
          </span>
          <div
            className="text-formaters-sm"
            style={{
              display: `${activeOption === "text-transform" ? "flex" : "none"}`,
            }}
          >
            <p className="toggler" onClick={() => setActiveOption("")}>
