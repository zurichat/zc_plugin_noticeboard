...
class MentionAdder extends Component {
  ...
  render() {
    return (
      <div onClick={this.addMention} className="rightIcons">{<img src={mentionIcon} alt="attachment icon"/>}</div>
    );
  }
}
...
class ToggleToolbar extends Component {
  ...
  render(){
    return (
      <div onClick={this.ToggleToolbar} className="rightIcons ToggleToolbar-btn">Ag</div>
    );
  }
}
