...
from .views import (Subscribe, install, create_room, sidebar_info, CreateNewNotices, 
                     ...
                     ViewNoticeAPI, NoticeDetail, Unsubscribe, emailNotificaion, NoticeReminder,ScheduleNotices,ViewSchedule,NoticeDraft, BookmarkNotice, CreateBookmark, DeleteBookmarkedNotice
                     )
