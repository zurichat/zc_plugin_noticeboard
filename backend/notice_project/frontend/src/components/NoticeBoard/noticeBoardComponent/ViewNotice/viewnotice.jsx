import React, { useEffect, useEffect, useContext } from "react";
...
const PinnedNotices = (props) => {
  ...
  useEffect(() => {
    fetch(
      `https://noticeboard.zuri.chat/api/v1/organisation/614679ee1a5607b13c00bcb7/notices/${selectedNotice._id}/copy`
