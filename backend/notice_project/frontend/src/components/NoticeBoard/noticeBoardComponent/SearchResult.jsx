		  ...
		  <div className="user-notice-post">
           ...
           <div className="user-notice-card">
              ...
              <div className="card-buttons-grp">
                <div>
                  <Button className="view-btn MuiButtonBase-root" variant="outlined">
                  View notice
                  </Button>
                </div>
              </div>
